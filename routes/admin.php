...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('complained-orders', 'Admin\ComplainedOrdersController@index')->name('admin.complained-orders.index');
    Route::get('complained-orders/{id}', 'Admin\ComplainedOrdersController@show')->name('admin.complained-orders.show');
