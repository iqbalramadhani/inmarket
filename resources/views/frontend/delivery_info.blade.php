                        ...
                        @foreach ($seller_products as $key => $seller_product)
                            <div class="card mb-3 shadow-sm border-0 rounded">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="spinner-border" id="spinner_{{ $key }}" role="status">
                                            <span class="sr-only">Loading...</span>
                                        </div>
                                        <div class="div" id="detail_cost_{{ $key }}">
                                        </div>
                                    </div>
...
<input type="hidden" name="total_weight" value="{{$data_shipping['total_weight']}}">
<input type="hidden" name="subdistrict_id_from" value="{{$data_shipping['subdistrict_id_from']}}">
<input type="hidden" name="subdistrict_id_to" value="{{$data_shipping['subdistrict_id_to']}}">
@endsection
@section('style')
