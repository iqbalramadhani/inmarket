        ...
        <div class="card-body">
            ...
            <div class="row mt-1">
                ...
                <div class="col-12 mt-3 text-center">
                    <a href="{{route('complain.form_delivery', ['complain_slug' => encrypt($complain->id) ])}}" class="btn btn-xs btn-primary mb-2 {{($complain->status=='accepted') ? '' : 'd-none'}}" >Refund</a>                    
                    ...
                    <a href="{{route('conversations.create', ['seller_id' => $complain->seller_id, 'customer_id' => auth()->user()->id, 'complain_id' => $complain->id])}}" class="btn btn-xs btn-warning mb-2" >{{translate('message seller')}}</a>                    
