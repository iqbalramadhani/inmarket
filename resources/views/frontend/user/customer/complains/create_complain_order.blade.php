...
@section('panel_content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">Complain Order {{$complain->order->code}}</h5>
        </div>

        <form action="{{ route('complain.order.store', ['order_id' => $complain->order->code])}}" method="POST" enctype="multipart/form-data">
