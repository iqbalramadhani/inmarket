            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select class="form-control aiz-selectpicker" data-live-search="true"
                        data-selected-text-format="" name="colors[]" id="colors" multiple>
                    ...
                    <!-- <div class="form-group aiz-switch aiz-switch-success mt-2">
                        <input value="1" type="checkbox" class="form-control" name="colors_active"
                    ...
                    <div class="custom-control custom-switch mt-2">
                        <input class="custom-control-input custom-control-input-sm" type="checkbox" id="enable_color" name="colors_active"
                            <?php if(count(json_decode($product->colors)) > 0) echo "checked";?>
                        >
                        <label class="custom-control-label" for="enable_color" style="padding:2px;line-height:1.5">{{translate('Enable')}}</label>
                    </div>
                </div>
            </div>
            ...
            <div class="customer_choice_options" id="customer_choice_options">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <!-- {{\App\Models\AttributeValue::where('attribute_id', $choice_option->attribute_id)->get()}} -->

                        <!-- <input class="d-block mt-1 form-control" placeholder="{{translate('Others')}}" name="choice_options_{{ $choice_option->attribute_id }}[]" value="asd" disabled> -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row d-none">
                        ...
                        <div class="col-md-6">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input disabledtype="radio" name="stock_visibility_state" value="hide"
...
<!--            <div class="form-group row">
            ...
            <div id="show-hide-div">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('SKU') }}" value="{{ $product->stocks->first()->sku ?? null }}" name="sku" class="form-control">
                    </div>
                </div>
            </div>
            <br>
...
<!--
    ...
    <div class="col-12">
        ...
        <div class="mar-all text-right register">
...
<script type="text/javascript">
    ...
    $("#choice_form").on("submit", function (evt) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-8">\
                        <select class="d-block form-control aiz-selectpicker attribute_choice" data-live-search="true" name="choice_options_'+ i +'[]" multiple>\
                            '+obj+'\
                        </select>\
                    </div>\
                </div>');
