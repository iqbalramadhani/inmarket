                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($order->complain()->get()->isNotEmpty() && $order->complain()->first()->status!= 'completed')
                                            <span class="badge badge-inline badge-primary font-weight-bold"> {{ translate('Complained') }}</span>
                                            @else
                                            @php 
                                    ...
                                    <td class="text-right">
                                        <a href="{{route('seller.order.detail', encrypt($order->id))}}" class="btn btn-soft-info btn-icon btn-circle btn-sm"  title="{{ translate('Order Details') }}">
