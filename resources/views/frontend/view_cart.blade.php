                    ...
                    <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                        <div class="mb-4">
                            ...
                            @foreach($data as $data)
                                    <input id="{{$data['shop']->id}}" class="checkAll" type="checkbox" onclick="checkAllItemBelow({{$data['shop']->id}})">
                                {{$data['shop']->name}}
                                ...
                                @foreach($data['products'] as $cartItem)
                                        ...
                                        <div class="row gutters-5">
                                            <div>
                                                <input type="checkbox" class="{{$data['shop']->id}} checboxsingle" data-cardId="{{ $cartItem['id'] }}" onclick="checkSingle({{$data['shop']->id}})" name="selected_product[]" value="{{$cartItem['product_id']}}">
                                            </div>
                                            ...
                                            <div class="col-lg col-6 order-4 order-lg-0">
                                                @if($cartItem['digital'] != 1 && $product->auction_product == 0)
                                                    <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                                                        ...
                                                        <input type="number" name="quantity[{{ $cartItem['id'] }}]" class="col border-0 text-center flex-grow-1 fs-16 input-number"
                                                               placeholder="1" value="{{ $cartItem['quantity'] }}"
                                                               min="{{ $product->min_qty }}" max="{{ $product_stock->qty }}"
                                                               data-price="{{ ($cartItem['price']) }}" onchange="updateQuantity(this)" data-idcart="{{ $cartItem['id'] }}">
                                            ...
                                            <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0">
                                                ...
                                                <span class="d-none totalPriceGetting totalPricePlain{{ $cartItem['id'] }}">{{($cartItem['price'] + $cartItem['tax']) * $cartItem['quantity']}}</span>
                                            </div>
        ...
        function checkSingle(identifier)
        {
            $("." + identifier).click(function () {
                if ($(this).is(":checked")){
                    ...
                    if(isAllChecked === 0){ $("#" + identifier).prop("checked", true); }
                }else {
