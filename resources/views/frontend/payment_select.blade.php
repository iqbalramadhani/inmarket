        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST" id="checkout-form">
                    @csrf
                    <input type="hidden" name="owner_ids" value="{{ $carts->pluck('owner_id')}}">
                                        ...
                                        @if(get_setting('oyid_payment') == 1)
                                            <div class="col-6 col-md-3">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/bank_transfer.png')}}" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                        ...
                                        @if(get_setting('oyid_payment') == 1)
                                            <div class="col-6 col-md-3">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/credit_card.png')}}" class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('Credit/Debit Card')}}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-6 col-md-3">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('E-Wallet')}}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
