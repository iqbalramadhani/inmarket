...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    */
    protected $fillable = [
        ...
        'is_agree_tos_customer', 'is_agree_tos_seller',
    ];
    ...
    */
    ...
    public function findAddressByProvince($province = '')
    {
        return $this->hasMany(Address::class);
    }
    ...
    public function bank_accounts() {
        return $this->hasMany(\App\Models\UserBankAccount::class, 'user_id', 'id');
    }
}
