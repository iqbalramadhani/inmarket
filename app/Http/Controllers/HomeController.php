...
//        $categories = Category::where('level', 0)->orderBy('name', 'asc')->get();
    ...
    public function show_product_edit_form(Request $request, $id)
    {
        ...
        $product->noMarkupUnitPrice = true;
        // $product->unit_price = $;
        // dd($product->toArray());
        $lang = $request->lang;
    ...
    public function seller_product_list(Request $request)
    {
        ...
        if ($seller->verification_status != 1) {
            flash(translate('Saat ini akun masih menunggu verifikasi'))->warning();
        ...
        return view('frontend.user.seller.products', compact('products', 'search', 'markup'));
    }
